...
export default function Navbar ({showCart, setShowCart, cart}) {
  ...
  return(
    <header className="relative top-0 sm:static bg-white">
      <nav className="hidden md:grid md md:p-8 md:border-b-2 md:max-w-7xl md:mx-auto">
        <ul className="flex justify-around text-darkGrayishBlue font-bold">
          <li>
          ...
          <li>
            <div className="relative hidden md:inline md:cursor-pointer">
              <svg 
      ...
      <div className="flex items-center justify-between p-6 gap-4 md:gap-16">
        {showMobileMenu ? (
